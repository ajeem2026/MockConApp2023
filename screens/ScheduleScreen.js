...
//     },
// });
/*this is abid's stuff*/

import React, { useState } from 'react';
import { StyleSheet, Text, View } from 'react-native';
import Swiper from 'react-native-swiper';
import { Calendar, CalendarUtils, DateRangePicker } from 'react-native-calendars';
...
function App() {
    ...
    return (
        <View style={stylesheet.container}>
            ...
            <Swiper style={stylesheet.swiper} height={1050} loop={true} showsButtons={true} >
                ...
                <View style={stylesheet.Slide} >
                    <View style={stylesheet.EventBase}>
                        ...
                        <Text style={stylesheet.EventDate}> 24 </Text>
                ...
                <View style={stylesheet.Slide} >
                    <View style={stylesheet.EventBase}>
                        ...
                        <Text style={stylesheet.EventDate}> 25 </Text>
                ...
                <View style={stylesheet.Slide} >
                    <View style={stylesheet.EventBase}>
                        ...
                        <Text style={stylesheet.EventDate}> 26 </Text>
                        <View style={stylesheet.EventDetailsBase}>
                            <Text style={stylesheet.EventName}> Lorem Ipsum </Text>
                            <Text style={stylesheet.EventDetails}> 9:00PM </Text>
                            <Text style={stylesheet.EventDetails}> Lorem Place </Text>
...
/*This is the end of Abid's stuff */
